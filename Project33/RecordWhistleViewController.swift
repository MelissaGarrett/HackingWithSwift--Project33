...
class RecordWhistleViewController: UIViewController, AVAudioRecorderDelegate {
    ...
    func loadRecordingUI() {
        // Use Dynamic Type to control fonts
        ...
        playButton.alpha = 0 // because button is hidden and in stackview
    ...
    func finishRecording(success: Bool) {
        ...
        whistleRecorder = nil // destroy the object
    ...
    // To handle if recording ended with a problem
